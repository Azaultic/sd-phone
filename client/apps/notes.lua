...
-- Thin delegates into server/notes: note CRUD and nearby sharing - validation + persistence
-- live in each server handler, documented there.
...
---Server push: a note shared to us was accepted server-side - relay it so the open app shows
---the new note without a refetch.
