        ...
        >
            ...
            <div className="flex-1 overflow-y-auto no-scrollbar px-4 pb-6">
                <div className="flex flex-col items-center pb-5 pt-1">
                    <div className="flex items-center justify-center rounded-full bg-[#b6b6bb] dark:bg-[#48484a]" style={{ width: 134, height: 134 }}>
                ...
                <div className="mb-4 rounded-[10px] bg-[#e5e5e5] px-4 py-3 dark:bg-[#1C1C1E]">
                ...
                {entry.number && (
                    <>
                        ...
                        <button
                            ...
                            className="w-full rounded-[10px] bg-[#e5e5e5] px-4 py-3.5 text-left text-[19px] text-ios-blue active:bg-black/5 dark:bg-[#1C1C1E] dark:active:bg-white/5"
                        >
...
function ActionButton({ icon, label }: { icon: ReactNode; label: string }) {
    return (
        <button type="button" className="flex flex-1 flex-col items-center gap-2 rounded-[12px] bg-[#e5e5e5] py-4 text-ios-blue active:opacity-70 dark:bg-[#1C1C1E]">
            {icon}
